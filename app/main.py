...
def statistics(
    ...
    driver_ids: list[int] | None = Query(default=None, description="Filter by drivers; omit for all"),
    regions: list[str] | None = Query(default=None, description="Filter by regions; omit for all"),
    start_date: date | None = Query(
        default=None,
        description="Inclusive UTC date; with end_date defaults omitted pair to today",
    ),
    end_date: date | None = Query(default=None, description="Inclusive UTC date"),
